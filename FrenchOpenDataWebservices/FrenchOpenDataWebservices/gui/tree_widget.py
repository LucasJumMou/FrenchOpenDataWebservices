...
from FrenchOpenDataWebservices.gui.tree_items import TreeWidgetItem
...
class TreeWidget(QTreeWidget):
    ...
    """
    The tree widget used in the FrenchOpenDataWebservices dock
    """
    ...
    def set_tree_content(self, resources_tree):
        ...
        if resources_tree is None:
            QgsMessageLog.logMessage(
                ...
                u"dans le panneau de l'extension FrenchOpenDataWebservices.",
                tag=u"FrenchOpenDataWebservices",
                level=Qgis.Warning,
            )
