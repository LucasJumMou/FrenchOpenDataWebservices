...
from FrenchOpenDataWebservices.gui.tree_widget import TreeWidget


class DockWidget(QDockWidget):
    """
    The dock widget containing the tree view displaying the FrenchOpenDataWebservices resources
    """
    ...
    def init_gui(self):
        """ """
        self.setWindowTitle(u"FrenchOpenDataWebservices")
