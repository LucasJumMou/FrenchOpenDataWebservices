...
class AboutBox(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        title = u"À propos de l'extension FrenchOpenDataWebservices…"
        description1 = """Extension pour QGIS donnant un accès simplifié aux ressources géographiques (webservices) 
        issus de multiples fournisseurs de données en OpenData ou du serveur interne d'Enercoop.""".format(
            PluginGlobals.instance().PLUGIN_VERSION
        )
        description2 = """Plus d'informations à l'adresse suivante : <a href="">GitHub </a>""".format(
